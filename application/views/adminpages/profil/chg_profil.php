<!--outter-wp-->
					<div class="outter-wp">
						...
						<div class="sub-heard-part">
							<ol class="breadcrumb m-b-0">
								...
								<li><a href="<?php echo site_url('admin_profile')?>">Profil</a></li>
						...
						<div class="graph-visual tables-main">
							<h2 class="inner-tittle">Edit Profil Admin</h2>
								<div class="graph">
									<div class="block-page">
										<form id="editprofil" method="post" action="<?php echo base_url(); ?>admin_profil/act_chg_profil/<?=$dsn_id?>"">
					<div class="vali-form">
						<div class="col-md-6 form-group1">
							<!-- <label class="control-label">Kode</label> -->
								<input type="hidden" name="kddosen" placeholder="Masukkan Kode" value="<?=$profil[0]->kd_dosen; ?>" >
						</div>
					...
					<div class="col-md-6 form-group1 group-mail">
						<label class="control-label">Nama</label>
							<input type="text" name="nmdosen" placeholder="Masukkan Nama" value="<?=$profil[0]->nm_dosen; ?>">
					</div>
						<div class="clearfix"> </div>
			...
			$.ajax({
				...
				success : function(data) {
					if(data.sts == 1) {
						...
						setTimeout(function() {
                            window.location.href = "<?php echo site_url('admin_profil'); ?>";
                        }, 2000);
					} else {
