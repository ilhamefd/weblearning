<!--outter-wp-->
					<div class="outter-wp">
						...
						<div class="graph-visual tables-main">
							<h2 class="inner-tittle">Foto Admin</h2>
								<div class="graph">
									<div class="block-page">
            <form  action="<?php echo base_url(); ?>admin_profil/act_chg_foto/<?php echo $dosen[0]->dsn_id ?>" method="post" enctype="multipart/form-data">
            <?php $i = 1;
