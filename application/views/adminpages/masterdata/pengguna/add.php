<!--outter-wp-->
					<div class="outter-wp">
						...
						<div class="graph-visual tables-main">
							<h2 class="inner-tittle">Tambah Pengguna</h2>
								<div class="graph">
									<div class="block-page">
										<form id="addpengguna" method="post" action="<?php echo base_url(); ?>admin_pengguna/act_add">
					<div class="vali-form">
						<div class="col-md-3 form-group1">
							<label class="control-label">Username</label>
								<input type="text" name="username" placeholder="Masukkan User Name">
						</div>
...
<script>
	$(document).ready(function(){
		$('#addpengguna').on('submit', function(e){
			e.preventDefault();
