            ...
            <div class="graph-visual tables-main">
                <div class="graph">
                  <div class="block-page">
                    ...
                    <hr>
                    <strong>Pengumpulan Tugas</strong><br><br>
                    <form method="post" action="<?php echo base_url(); ?>mhs_course/submit_tgs/<?=$value->mtr_id?>" enctype="multipart/form-data">
                      <input type="file" name="img" required><br>
                      <button type="submit" class="btn btn-primary">Kumpulkan</button>
                    </form>
                    <hr>
                    <strong>Tambahkan Komentar</strong><br><br>

                    <form id="addkomentar" method="post" action="<?php echo base_url(); ?>mhs_course/add_komen/<?=$value->mtr_id?>"">
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <form id="addbalasan" method="post" action="<?php echo base_url(); ?>mhs_course/add_balasan/<?=$value->mtr_id?>">
