					...
					<div class="outter-wp">
						...
						<div class="sub-heard-part">
							<ol class="breadcrumb m-b-0">
								...
								<li><a href="<?php echo site_url('dosen_profile')?>">Profil</a></li>
						...
						<div class="graph-visual tables-main">
							<h2 class="inner-tittle">Edit Profil Dosen</h2>
								<div class="graph">
									<div class="block-page">
										<form id="editprofil" method="post" action="<?php echo base_url(); ?>dosen_profil/act_chg_profil/<?=$dsn_id?>"">
					<div class="vali-form">
			...
			$.ajax({
				...
				success : function(data) {
					if(data.sts == 1) {
						...
						setTimeout(function() {
                            window.location.href = "<?php echo site_url('dosen_profil'); ?>";
                        }, 2000);
					} else {
