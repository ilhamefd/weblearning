<!--outter-wp-->
					<div class="outter-wp">
						...
						<div class="graph-visual tables-main">
							<h2 class="inner-tittle">Tambah Soal</h2>
								<div class="graph">
									<div class="block-page">
										<center><?=$this->session->flashdata('pesan');?></center>
										<p>Halaman ini merupakan tempat upload soal.<hr> 
										<form id="ads" action="<?php echo base_url(); ?>dosen_soal/form" method="post">
											...
											<div class="vali-form">
												<div class="col-md-2 form-group1">
													<label class="control-label">Jumlah Soal</label>
														<input type="text" name="jumlah" value="" required>
												</div>
											...
											<div class="vali-form">
												<div class="col-md-3 form-group1">
													<label class="control-label">Jumlah Tujuan Pembelajaran</label>
														<input type="text" name="tujuan" value="" required>
												</div>
												
											</div>
											<div class="clearfix"></div>

    										<input type="submit" class="btn btn-primary" value="Lanjut"/><br><br>
										</form>
									</div>
						        </div>
						</div>
